...
void Serialization::FullSerialize(const transport_catalogue::TransportCatalogue& catalogue, const map_renderer::MapRenderer& renderer, graph::DirectedWeightedGraph<double>*& graph, const TransportRouter& transport_router) {
